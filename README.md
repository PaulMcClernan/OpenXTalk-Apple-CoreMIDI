...
- maybe Port to LCB, or replace with LCB, UDI's Hypercard style 'ABC' Notation compatible opensource LCS Lib called makeSMF. This library was very well written all the way back in the early 2000s (late 1990s?), I've slightly updated it, mostly to use 'bytes' instead of 'char' keyword (since LiveCode has since become fully Unicode compatible, a 'char' could be a multi-byte unicode.
